...
*The base layer of the token evacuation strategy: a streaming symbol table that replaces repeated n-grams with short codes, forming the lossless floor beneath SQ-C (phrase clusters), SQ-D (sentence templates), SQ-E (dialogue arcs), and SQ-ZT (weight residency). See Guide 87 for the full stack definition.*
